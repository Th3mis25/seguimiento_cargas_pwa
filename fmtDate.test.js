...
assert.strictEqual(fmtDate(isoSample, 'es-MX'), '09/06/2024 15:30');
...
assert.strictEqual(fmtDate(customSample, 'es-MX'), '09/06/2024 15:30');
...
assert.strictEqual(fmtDate(diffSample, 'es-MX'), '30/08/2025 08:00');
...
assert.strictEqual(fmtDate(isoZSample, 'es-MX'), '09/06/2024 15:30');
