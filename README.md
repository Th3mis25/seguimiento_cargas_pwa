...
- La autenticación se realiza contra un backend que valida contraseñas hasheadas y emite tokens.
...
```
El backend expone un endpoint de login que recibe usuario y contraseña. Si las
credenciales son válidas, devuelve un token temporal que la PWA enviará en cada
petición.
